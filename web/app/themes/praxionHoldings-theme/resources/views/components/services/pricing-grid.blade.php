...
<section id="pricing" aria-labelledby="pricing-title" class="scroll-mt-24 py-20 sm:py-24 lg:py-32">
    <div class="container-page">
        ...
        <div class="mt-12 grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            ...
            <article @class([ 'group relative flex min-h-full transform-gpu flex-col rounded-3xl border bg-white p-6 shadow-sm transition-[transform,border-color,box-shadow,background-color] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform hover:-translate-y-1 hover:border-primary/35 hover:bg-brand-light/20 hover:shadow-xl hover:shadow-primary/10 sm:p-8' , 'border-primary ring-2 ring-primary/10'=> $billingTerm['recommended'] ?? false,
                ...
                <div class="flex flex-row items-center justify-between">
                    ...
                    <p class="inline-flex w-fit rounded-full bg-primary px-3 py-1.5 text-xs font-semibold text-white transition-colors duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:bg-primary-dark">
                ...
                <div
                    ...
                    <p class="flex items-start gap-2 text-sm font-semibold leading-6 text-primary-dark">
                        <i data-lucide="badge-percent"
                            ...
                            aria-hidden="true"></i>
                        30% off the next billing cycle only
                    </p>
                    @else
                    <p class="text-sm leading-6 text-muted">No next-cycle discount is specified for this term.</p>
                    @endif
                </div>
            </article>
            @endforeach
        ...
        <aside class="mt-8 rounded-2xl border border-primary/15 bg-brand-light p-5 sm:flex sm:items-start sm:gap-4 sm:p-6"
            aria-label="Next billing cycle discount note">
            <i data-lucide="info" class="h-6 w-6 shrink-0 text-primary" aria-hidden="true"></i>
            <div class="mt-3 sm:mt-0">
                <p class="font-semibold text-text-dark">How the 30% benefit works</p>
                <p class="mt-1 leading-7 text-muted">
                    Only the 12-month and Elite 24-month packages receive 30% off the next billing cycle. This is a one-cycle benefit, not a permanent discount.
                </p>
            </div>
        </aside>
    </div>
